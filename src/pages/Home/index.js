          ...
          <Container>
            ...
            <Row className="hiw-items mt-30">
              ...
              <div>
                ...
                <p>
                  Conte-nos em poucas palavras o que você precisa. É grátis e
                  sem compromisso!
                </p>
              </div>
            </Row>
            <Row className="hiw-items mt-30">
              ...
              <div>
                ...
                <p>
                  Receba propostas de excelentes contadores. Escolha o melhor
                  para o seu projeto.
                </p>
              </div>
            </Row>
            <Row className="hiw-items mt-30">
              ...
              <div>
                ...
                <p>
                  Você faz o pagamento com total garantia sobre o valor
          ...
          >
            ...
            <div className="bg-red">
              <Container>
                ...
                <p>
                  Na Accountant contrato vários profissionais ao mesmo tempo,
                  assim não há atrasos e o resultado é sempre muito bom. Claro
                  que tive problemas, mas tenho autonomia para resolver e partir
                  para um próximo freelancer.
                </p>
              </Container>
            </div>
          </Carousel>
